...
import ScenarioRentalPage from "./components/ScenarioRentalPage";
...
export default function App() {
  // 1. 상태 선언
  const [currentView, setCurrentView] = useState<"landing" | "login" | "rental" | "scenario" | "monitor" | "defect" | "rent">("login");
